    ...
    return (
      <button
        ...
        className={cn(
          ...
          {
            "bg-gradient-mint text-primary-foreground shadow-lg shadow-primary/20 hover:shadow-primary/40 hover:-translate-y-0.5": variant === "default",
            "border border-border bg-transparent hover:bg-primary/5 hover:text-foreground": variant === "outline",
            "hover:bg-primary/5 hover:text-foreground": variant === "ghost",
